...
public class TrianguloFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CÁCULO DEL ÁREA DEL TRÍANGULO");
    ...
    private void btn_calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcularActionPerformed
        Triangulo tri = new Triangulo(Float.parseFloat(txt_base.getText()), Float.parseFloat(txt_altura.getText()));
        tri.calcularArea();
        lbl_resultado.setText(tri.resultado());
